...
cppbuild: 
	...
	cxx -o $(EXE) $(OBJS) -L$(LIBHOME) $(PROLDLIBS)
cppbuild_static: 
	$(PROC) $(PROCPPFLAGS) iname=$(EXE)
	cxx -x cxx -c -DA_OSF $(INCLUDE) $(EXE).c
	cxx -o $(EXE) $(OBJS) -L$(LIBHOME) $(STATICCPPLDLIBS)
$(CPPSAMPLES):
...
PROCFLAGS= sqlcheck=full userid=$(USERID)
